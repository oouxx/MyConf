...
(defun my-display/init-all-the-icons ()
...
(defun my-display/init-all-the-icons-ivy ()
...
(defun my-display/post-init-spaceline-all-the-icons ()
...
(defun my-display/init-pretty-code ()
...
;;(defun my-display/init-pretty-eshell ()
...
(defun my-display/init-pretty-outlines ()
