...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(pyim pyim-basedict pyim-cangjie5dict pyim-wbdict smooth-scrolling)
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;; C-M-J ivy-immediate-done 解决find-file的问题
...
before packages are loaded."
  ...
  ;; git-gutter+-refresh: Wrong type argument: arrayp, (tramp-file-name "ssh" "root" nil "wangxinxing.xyz" nil "/root/docker/my_video_website/dnmp/www/localhost/template/maodou/html/public/banner.html" nil)
  ;; SOLUTION https://github.com/nonsequitur/git-gutter-plus/issues/42#issuecomment-464463744
  ...
  ;; https://github.com/kiwanami/emacs-epc/issues/35#issuecomment-566961272
  ;; package cl is deprecated issue
...
unwanted space when exporting org-mode to hugo markdown."
  ...
  ;; add notify.el
  (use-package notify
    :load-path  "~/.spacemacs.d/private/notify.el"
    :defer t)
